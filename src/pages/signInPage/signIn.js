    ...
    <div>
      ...
      <Container className="mt-3">
        ...
        <p>
          ...
          contributions, or you can actually give your clients for payment. You will be able to withdraw funds if its
          your company
        </p>
        <h2>How do i contribute</h2>
        <p>
          Simply join the company. Push a commit to github and let the project owner know by adding your pull request
          link
        </p>
        <p>
          Very simply put, you will be able to contribute to github projects that sign up. Once the github project owner
          is happy with your contribution he will click pay, and you will get money.
        </p>
        <p>
          If there is interest for this a project, I will improve it until it becomes as seamless as pushing a commit in
          order to earn Bitcoin for your work. For now the owner of the project will have to know which user made the
          contribution of github, and pay them here.
        </p>
        <h2>How much will i get per contribution</h2>
        <p>
          I have designed a stock market like funcionality where you can estimate a merge request value. An algorithm
